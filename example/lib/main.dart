        ...
        children: [
          ...
          _buildExampleCard(
            ...
            () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const FuzzySearchExample(),
                )),
          ),
          const SizedBox(height: 16),
          _buildExampleCard(
            ...
            () => Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => const AccessibilityExample(),
                )),
          ),
        ],
      ),
...
// =============================================================================
// Example 12: Fuzzy Search with SearchHighlightText
// QA Tests:
//   1. Type "apl" -> "Apple" appears (fuzzy subsequence match)
//   2. Type "apple" -> "Apple" scores 1.0, appears first
//   3. Type "xyz" -> empty results
//   4. Toggle fuzzy off -> "apl" finds nothing (exact substring only)
//   5. SearchHighlightText highlights matched characters
// =============================================================================
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                      'Threshold: ${_threshold.toStringAsFixed(1)} (${_threshold < 0.3 ? "lenient" : _threshold > 0.6 ? "strict" : "balanced"})'),
                  Slider(
                    value: _threshold,
                    min: 0.1,
                    max: 0.9,
...
// =============================================================================
// Example 13: Accessibility & Localization
// QA Tests:
//   1. Enable TalkBack/VoiceOver -> search field announces "Buscar frutas"
//   2. Type "App" -> after debounce, screen reader announces "1 resultado encontrado"
//   3. Clear button tooltip says "Borrar busqueda"
//   4. Toggle language -> labels switch between English and Spanish
// =============================================================================
